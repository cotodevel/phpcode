							...
							for($f=0;$f<$nreg;$f++){
								...
								switch($fdata[1]):
									case($tab[0]):
										...
										echo "<a href=javascript:popUp('./elim_reg.php?det=".$temp[$f][1].$sep_int.$temp[$f][3].$sep_int.$temp[$f][4].$sep_int.$temp[$f][5]."')><font color='blue' size='-1'>Campo: [<b>".$temp[$f][5]."</b>] - Registro(s): [".$cnt_reg."]</font></a><p></p>";
									break;
								endswitch;
...
//gui
echo "<center><font size='+1'><b>*Haga click en el campo, el cual deseas eliminar datos*</b><p></p><a href='javascript:window.close()'>Cerrar Ventana</a></font><p></p>";
