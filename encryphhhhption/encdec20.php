...
//borramos password decoded una vez escondido
unset($main_pass);
...
return $encoded;
unset($cont,$ncoded,$w_del,$indice,$encoded,$shuff_ind,$b64encind_ori,$res);
}
...
unset($key,$b64decind,$totchar,$i,$ind,$chword,$cont,$keyw,$i_dec,$string_sinpw,$string,$string_enc,$pw_built);
return $pw_dec;
}
?>